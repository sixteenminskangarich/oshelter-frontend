...
export default function FourthStage({ values, handleChange, handleBlur, errors}) {
    ...
    return(
        <>
            <div className="flex w-full flex-col pb-8 -mt-10">
                <div className="pb-12">
                    <h2 className="text-base/7 font-semibold text-gray-900">Emergency Contact information</h2>
                    <p className="mt-1 text-sm/6 text-gray-600">Please provide details for your first director.</p>
