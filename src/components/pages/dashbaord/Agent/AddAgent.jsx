...
import {addAgentCaretaker} from '../../../../utils/request';
...
const AddAgent = () => {
    ...
    const mutation = useMutation(
		(agentData) => addAgentCaretaker(agentData, token),
		{
			onSuccess: (data) => {
                                ...
                                <div className="w-full flex-1 mt-8">
                                    <form onSubmit={handleSubmit}>
                                        <div className="mx-auto max-w-xs">
                                            ...
                                            <button
                                                type="submit"
                                                className="mt-5 tracking-wide font-semibold bg-bg-color text-gray-100 w-full py-2 rounded-lg hover:bg-black transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                                                <span className="ml-3">
