...
import { getPropertiesByStatus } from '../../../../utils/request';
...
const PropertiesByType = () => {
    ...
    const {
		...
		queryKey: ['property', { key, token }],
		queryFn: () => getPropertiesByStatus(key, token),
                                                                ...
                                                                results?.map((property, index) => (
                                                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                                        ...
                                                                        <td className="mr-4 py-4">
                                                                            ...
                                                                            <span className="bg-pink-800 text-white text-xs font-medium me-2 px-3 py-1 rounded-full dark:bg-pink-900 dark:text-pink-300 font-thin">For {property.marketType}</span>
                                                                        </td>
                                                                        ...
                                                                        <td className="px-6 py-4">
                                                                            {
                                                                                property?.status === "pending" ?
                                                                                (
                                                                                    <span className="bg-green-800 text-white text-xs font-thin me-2 px-2.5 py-0.5 rounded-lg dark:bg-gray-700 dark:text-green-400 border border-indigo-400">Pending</span>
                                                                                ): property?.status === "completed" ? (
