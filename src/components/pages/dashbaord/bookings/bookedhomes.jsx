...
import { fetchBookingsByState, updateBookings } from '../../../../utils/request';
...
const BookedHomes = () => {
    ...
    const {
		...
		queryKey: ['bookings', { state, token }],
		queryFn: () => fetchBookingsByState(state, token),
        ...
        <div className='flex font-josefin-sans'>
            ...
            <div className='p-4 sm:ml-64 flex-1 mt-16 overflow-y-scroll h-[700px]'>
                <div className="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <h3 className="text-2xl font-medium text-gray-900 dark:text-white mb-2">Booking Request</h3>
                    <br />
                    {
                        results ? (
                            w <= 789 || w <= 810 ? (
                                                                    ...
                                                                    <div className="flex-1 min-w-0 ms-4 mt-4">
                                                                        ...
                                                                        <p className="flex text-md tracking-wider text-gray-500 dark:text-gray-400">
                                                                            ...
                                                                            {bookings.status === "PENDING" ? (
                                                                                <span className="bg-green-100 text-indigo-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-indigo-400">Pending</span>
                                                                            ): bookings.status === "rejected" ? (
                                                                                <span className="bg-green-100 text-indigo-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-danger-400 border border-danger-400">Rejected</span>
                                                                            ) :
                                                                            (
                                                                                <span className="bg-green-100 text-indigo-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-indigo-400">Approved</span>
                                                                            )}
                                                                        </p>
                                                                        <br />
